...
const position = { lat: 6.5765376, lng: 3.3521664 };
  ...
  const editBgImageCover = () => {
    dispatch(
      modalActions.show({
        ...
        props: { maxWidth: "md", open: true, fullWidth: true },
      })
    );
  };
  const editImage = () => {
  ...
  return (
    <section className={css.orphanage_account_dashboard}>
        ...
        <div className={css.details_section}>
          ...
          <div className={css.left}>
            <div className={css.name_container}>
              ...
              <span className={css.tagline}>Giving hope to needy children</span>
            </div>
      ...
      <div className={css.about_section} id="about">
        <EditIcon className={css.edit} background />
        <span>About</span>
        <About desc={about} />
      </div>
